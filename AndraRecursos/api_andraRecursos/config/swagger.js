const documentacao = {
  ...
  servers: [
    //LocalHost
    { url: "http://localhost:3001", description: "Servidor Localhost" },

    //Vercel
    { url: "https://api-andra-recursos.vercel.app", description: "Vercel" },
  ],
  tags: [
      ...
      delete: {
        ...
        responses: {
          ...
          404: {
            ...
            content: {
              "application/json": {
                example: { message: "Solicitação não encontrada" },
              },
            },
          },
          500: {
  ...
  components: {
    ...
    schemas: {
      ...
      Login_Administrador: {
        ...
        properties: {
          email: { type: "string", example: "coloqueseu@email.com" },
